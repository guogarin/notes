...
&emsp;&emsp; 在例句⑤ 中，`tigers`指的是整个老虎这种动物的物种， 我们想的是“老虎”这类动物，并不是专门想到特定的一只老虎， 即表示泛指，所以不能说 ~~The tigers are becoming almost extinct.~~
...
### 2.4.4 单数名词 与不定冠词`a/an`连用 可以表示泛指
