...
### 4.8.3 使用 yield from 计算平均值并输出统计报告
```python
'coroaverager3.py'
...
&emsp;&emsp; 在python3.5之前，python的协程都是 基于生成器的协程(generator based coroutines)
