...
- [2. `multiprocessing`模块](#2-multiprocessing模块)
	...
	- [2.4 `multiprocessing`的进程池](#24-multiprocessing的进程池)
		- [2.4.1 `multiprocessing`的进程池？](#241-multiprocessing的进程池)
		- [2.4.2 如何使用`multiprocessing`的进程池？](#242-如何使用multiprocessing的进程池)
...
### 2.4.1 `multiprocessing`的进程池？
&emsp;&emsp;利用 `Pool` 类

### 2.4.2 如何使用`multiprocessing`的进程池？
