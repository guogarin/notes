...
&emsp; Python3 确实有机会从头开始，包括重写现存的一些 C 扩展。那么 Python3 最终还是没有移除 GIL 呢？原因如下：
> &emsp;&emsp; 得益于 GIL，Python的单线程的效率很高，而如果移除 GIL 的话，Python3 相比 Python2 在单线程的执行速度会变慢；
> 
...
&emsp;
## 2.7 GIL锁的存在是否意味着python多线程一点用也没有了？
&emsp;&emsp; 
