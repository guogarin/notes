...
> &emsp;&emsp; 随着原生协程(native coroutines)在python3.5的加入，python核心开人远远逐渐不再支持经典协程(classic coroutines)了，但原生协程和经典协程的底层原理其实是一样的。原生协程的语法使得协程更容易被区分出来(这里指的是容易和生成器函数区分开来)。在原生协程中，不再使用`yield from`来委派协程，取而代之的是`await`关键字。
> 
...
https://zhuanlan.zhihu.com/p/27546366

https://zhuanlan.zhihu.com/p/28334506

https://www.icode9.com/content-1-1288297.html

https://zhuanlan.zhihu.com/p/452223418

https://www.cnblogs.com/zunwen/p/14027338.html