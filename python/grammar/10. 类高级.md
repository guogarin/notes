...
- [6. 运算符重载(Operator Overloading)](#6-运算符重载operator-overloading)
  ...
  - [6.4 重载向量加法运算符`+`(Overloading `+` for Vector Addition)](#64-重载向量加法运算符overloading--for-vector-addition)
  - [6.](#6)
  - [6.](#6-1)
  - [运算符可以修改操作数吗？](#运算符可以修改操作数吗)
...
&emsp;
## 6.4 重载向量加法运算符`+`(Overloading `+` for Vector Addition)
