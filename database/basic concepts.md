...
- [四、数据库设计](#四数据库设计)
  ...
  - [2. 第一范式（1NF）](#2-第一范式1nf)
    - [2.1 定义](#21-定义)
    - [2.2 1NF 的意义](#22-1nf-的意义)
    - [2.3 实例解析1NF](#23-实例解析1nf)
    - [2.4 MySQL（或Oracle）中有不符合 1NF的表吗？](#24-mysql或oracle中有不符合-1nf的表吗)
  - [3. 第二范式（2NF）](#3-第二范式2nf)
    - [3.2 为何需要2NF](#32-为何需要2nf)
    - [3.2 定义](#32-定义)
...
### 2.4 MySQL（或Oracle）中有不符合 1NF的表吗？
