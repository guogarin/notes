...
- [四、数据库设计](#四数据库设计)
  - [1. 范式(Normal Form)](#1-范式normal-form)
    ...
    - [1.3 为什么需要范式](#13-为什么需要范式)
  - [2. 三范式的基本定义](#2-三范式的基本定义)
  - [3. 第一范式（1NF）](#3-第一范式1nf)
    - [3.1 定义](#31-定义)
    - [3.2 1NF 的意义](#32-1nf-的意义)
    - [3.3 实例解析1NF](#33-实例解析1nf)
    - [3.4 MySQL（或Oracle）中有不符合 1NF的表吗？](#34-mysql或oracle中有不符合-1nf的表吗)
  - [4. 第二范式（2NF）](#4-第二范式2nf)
    - [4.1 定义](#41-定义)
    - [4.2 为何需要2NF](#42-为何需要2nf)
  - [5. 第三范式（3NF）](#5-第三范式3nf)
    - [5.1](#51)
    - [5.2 为何需要2NF](#52-为何需要2nf)
- [数据库事务](#数据库事务)
- [引擎](#引擎)
